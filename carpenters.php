    ...
    <div class="form-group">
      <div class="row">
        <div class="col-md-6">
          ...
          <input type="text" readonly class="form-control-plaintext" id="staticTextBox1" value=" Make a New Furniture" style="border: 1px solid #ccc;" />
        </div>
        <div class="col-md-6">
         
          <input type="text" readonly class="form-control-plaintext" id="staticTextBox2" value=" Repair The Existing Furniture" style="border: 1px solid #ccc;" />
        </div>
      </div>
      <div class="row mt-3">
        <div class="col-md-6">
         
          <input type="text" readonly class="form-control-plaintext" id="staticTextBox3" value=" Assemble/disassemble" style="border: 1px solid #ccc;" />
        </div>
        <div class="col-md-6">
          
          <input type="text" readonly class="form-control-plaintext" id="staticTextBox4" value=" Polish/Varnish the furniture" style="border: 1px solid #ccc;" />
        </div>
      </div>
    </div>
    <p class="card-text"></p>
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image11.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">Achari and Sons</h5>
        <p class="card-text">Rating: 4.5/5</p>
        <p class="card-text card-text-location" id="kadapa">Location:kadapa</p>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Email: Achari@gmail.com</p>
        <p>Phone: +6895898884</p>
      </div>
    </div>
  </div>
</div> 
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image12.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">The Mahesh Satya Bhama House</h5>
        <p class="card-text">Rating: 8.5/5</p>
        <p class="card-text card-text-location" id="kadapa">Location:kadapa</p>
...
<div class="modal fade" id="contactModal2" tabindex="-1" role="dialog" aria-labelledby="contactModalLabel2" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Email: Mahesh@gmail.com</p>
        <p>Phone: +8734449737</p>
      </div>
    </div>
  </div>
</div>
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image13.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">Mr Sudhakar</h5>
        <p class="card-text">Rating: 6.5/5</p>
        <p class="card-text card-text-location" id="Rayachoti">Location:Rayachoti</p>
...
<div class="modal fade" id="contactModal3" tabindex="-1" role="dialog" aria-labelledby="contactModalLabel3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Email: Sudhakar@gmail.com</p>
        <p>Phone: +7635075375</p>
      </div>
    </div>
  </div>
</div>
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image14.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">Sri Venkateshwara Vegetable NUrsery</h5>
...
<div class="modal fade" id="contactModal3" tabindex="-1" role="dialog" aria-labelledby="contactModalLabel3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Email: Venkateshwara@gmail.com</p>
        <p>Phone: +9864383458</p>
      </div>
    </div>
  </div>
</div>
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image15.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">Showry Wood Works</h5>
        <p class="card-text">Rating: 4.5/5</p>
        <p class="card-text card-text-location" id="vempalli">vempalli</p>
...
<div class="modal fade" id="contactModal5" tabindex="-1" role="dialog" aria-labelledby="contactModalLabel5" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Email: Showry@gmail.com</p>
        <p>Phone: +4398747389</p>
      </div>
    </div>
  </div>
</div>
...
<?php
   $con=mysqli_connect("localhost","root","","data");
    $result = mysqli_query($con, "SELECT * FROM carpenter");
